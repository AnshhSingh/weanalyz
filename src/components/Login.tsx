...
function Login() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#4ad6c2", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ background: "#b2e3df", borderRadius: 4, width: 600, height: 400, boxShadow: "0 2px 16px #b0e0e6", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", position: "relative" }}>
        <h1 style={{ fontFamily: 'sans-serif', fontWeight: 700, fontSize: 36, marginBottom: 36, fontStyle: 'italic', textAlign: 'center', marginTop: -30 }}>Helpdesk System</h1>
        ...
        <div style={{ width: 400, display: "flex", justifyContent: "space-between", position: "absolute", left: 100, bottom: 36 }}>
          ...
          <span style={{ color: "#111", fontSize: 18, cursor: "pointer", textAlign: "right" }} onClick={() => navigate('/signup')}>Sign Up</span>
        </div>
      </div>
    </div>
  );
